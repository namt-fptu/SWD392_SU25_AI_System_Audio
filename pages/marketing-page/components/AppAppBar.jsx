        ...
        <StyledToolbar variant="dense" disableGutters>
          <Box sx={{ flexGrow: 1, display: 'flex', alignItems: 'center', px: 0 }}>
            ...
            <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
              ...
              <Button variant="text" color="info" size="small" component="a" href="#testimonials">
                Testimonials
              </Button>
              <Button variant="text" color="info" size="small" component="a" href="#highlights">
                Highlights
              </Button>
              <Button variant="text" color="info" size="small" component="a" href="#pricing">
                Pricing
              </Button>
              <Button variant="text" color="info" size="small" sx={{ minWidth: 0 }} component="a" href="#faq">
                FAQ
              </Button>
              <Button variant="text" color="info" size="small" sx={{ minWidth: 0 }} component="a" href="#blog">
                Blog
              </Button>
            </Box>
          </Box>
